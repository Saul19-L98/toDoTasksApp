...
export const PORT = envFound.parsed?.API_PORT || process.env.PORT;
...
}:${envFound.parsed?.API_ORIGIN_PORT || process.env.PORT}`;

//For the script set-env.ts
export const NODE_API_PORT = envFound.parsed?.API_PORT || process.env.PORT;
